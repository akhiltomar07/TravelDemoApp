...
//All actions like sendkeys, click, mousehover, click etc

public class ActionEngine {

	// Customized sendkeys method--> To log sendkeys message
	...
	// custom click method to log every click in extent report
